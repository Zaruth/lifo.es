...
function iface()
{
  global $conftitle, $confcontentstart, $confcontentend, $jug, $ident, $publico, $form, $tags, $hidelogin, $confcontentbeffooter, $time, $confabierto, $conftitlebar, $conftp, $us, $_SESSION, $ultimaact, $vmen, $vfor, $imgroot, $root, $nameJug, $conflogin;
...
<script type=\"text/javascript\" src=\"jquery-1.4.2.min.js\"></script>
  ...
  echo '<br/><br/>';
  imenuitemi('[Campanas Reales]', 'campanasreales.php');
  echo '<br/>';
  ...
  echo ' - ';
  imenuitemi('Relatos', 'relato.php');
  echo ' - ';
  //imenuitemi('Clasificación', 'clasificacion.php');
  echo '<strike>Clasificación</strike>';
  echo ' - ';
  //imenuitemi('Donaciones', 'donaciones.php');
  echo '<strike>Donaciones</strike>';
  echo ' - ';
  //imenuitemi('Transferir joyas', 'transjoyas.php');
  echo '<strike>Transferir joyas</strike>';
  echo ' - ';
  imenuitem('Cambiar Partida', 'https://lifo.es');
  echo ' - ';
  ...
  echo ' - ';
  imenuitemi('Explorar', 'explorar.php');
  echo ' - ';
  ...
  if(get_hora($time)==5 && get_minutos($time)>=0 && get_minutos($time) <=59){
    echo '<br>';
    imenuitemi('[Bosque de Lifo]', 'casadealtorias.php');
  }
